...
export function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#eef6ff] text-slate-950 dark:bg-[#050b14] dark:text-slate-100">
      ...
      {/* Main content */}
      <main className="relative z-10 mx-auto grid min-h-[calc(100svh-112px)] max-w-[1240px] grid-cols-1 items-center gap-12 px-6 pb-20 pt-3 sm:px-8 lg:grid-cols-[1fr_480px] lg:gap-20 lg:px-10 lg:pb-24">
        {/* Left: Marketing */}
